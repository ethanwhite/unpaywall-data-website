<template>
    <div class="page integrations">
        ...
        <ul>
            <li>
                <a href="https://knowledge.exlibrisgroup.com/360_Services/360_Link/0Product_Documentation/Overview/360_Link_with_IEDL%3A_Open_Access_Lookup_Service_Integration">360
                    Link</a>
            </li>
        ...
        <ul>
            <li>US National Institutes of Health</li>
            <li>UK REF 2021 (Research Excellence Framework)</li>
        ...
        <ul>
            ...
            <li>
                <a href="https://ec.europa.eu/info/research-and-innovation/strategy/goals-research-and-innovation-policy/open-science/open-science-monitor/trends-open-access-publications_en">European Open Science Monitor</a></li>
        ...
        <ul>
            <li><a href="https://www.facten.com/">Facten</a></li>
